...
1. **GitHub Private Vulnerability Reporting** (preferred): Use the [Security Advisories](https://github.com/huntinformationsystems/provara/security/advisories/new) feature on this repository to report privately.
