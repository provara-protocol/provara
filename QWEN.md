...
> Full project context is in **AGENTS.md**. Read it first. This file adds Qwen-specific operational guidance.
...
3. **Read MEMORY.md** at `C:\Users\c8324\.qwen\projects\C--provara\memory\MEMORY.md` — it contains cross-session learnings. Update it when you discover something that should persist.
