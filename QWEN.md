...
3. **Read MEMORY.md** at `$HOME\.qwen\projects\C--provara\memory\MEMORY.md` — it contains cross-session learnings. Update it when you discover something that should persist.
